...
'''
perform crud operations on the paient model using class based views
use function based views on the clinical data to perform special functions
create a detailview later on
'''
...
def addData(request,**kwargs):
    form = ClinicalDataForm() #create form
